  ...
  void initState() {
    ...
    _router = GoRouter(
      ...
      routes: [
        ...
        GoRoute(path: AppRoutes.instapay,       builder: (_,__) => const InstaPayScreen()),
        GoRoute(path: AppRoutes.bankTransfer,   builder: (_,__) => const BankTransferScreen()),
        GoRoute(path: AppRoutes.smartBilling,   builder: (_,s)  => SmartBillingScreen(category: s.extra is String ? s.extra as String : 'ELECTRICITY')),
        GoRoute(path: '${AppRoutes.requestChat}/:id', builder: (_,s) => UserRequestChatScreen(requestId: s.pathParameters['id']!)),
